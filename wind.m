classdef wind < handle
    ...
    methods
        ...
        function [wind_static,wind_gust] = get(self,t)
            wind_static = self.base;

            white_noise = randn;
            wind_gust(1,1) = self.gust(1).propigate(white_noise,t);
            wind_gust(2,1) = self.gust(2).propigate(white_noise,t);
            wind_gust(3,1) = self.gust(3).propigate(white_noise,t);
        end
    end
end